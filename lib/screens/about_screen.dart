    ...
    return AppScaffold(
      ...
      child: AnimatedScrollView(
        ...
        children: [
          ...
          Text(APP_NAME, style: boldTextStyle(size: 18)),
          8.height,
            ...
            children: [
              if (appStore.helplineNumber.isNotEmpty)
                Container(
                  height: 80,
                  width: 80,
                  decoration: boxDecorationWithRoundedCorners(borderRadius: radius(), backgroundColor: secondaryPrimaryColor),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      Image.asset(ic_call, height: 20, color: primaryColor),
                      Text(language.lblCall, style: secondaryTextStyle()),
                    ],
                  ),
                ).onTap(() {
