        ...
        children: [
          FutureBuilder<List<ServiceData>>(
            ...
            builder: (context, snap) {
              ...
              return snapWidgetHelper(snap, loadingWidget: FavouriteServiceShimmer());
            },
          ),
          Positioned(
            bottom: 8,
            left: 0,
            right: 0,
            child: Observer(builder: (context) => FavouriteServiceShimmer().visible(appStore.isLoading && page != 1)),
          ),
        ],
      ),
    );
