        ...
        children: [
          FutureBuilder<List<UserData>>(
            ...
            builder: (context, snap) {
              if (snap.hasData) {
                if (snap.data.validate().isEmpty) return BackgroundComponent(text: language.noProviderFound, subTitle: language.noProviderFoundMessage);
              ...
              return snapWidgetHelper(snap, loadingWidget: FavouriteProviderShimmer());
            },
          ),
          Positioned(
            bottom: 8,
            left: 0,
            right: 0,
            child: Observer(builder: (context) => FavouriteProviderShimmer().visible(appStore.isLoading && page != 1)),
          ),
        ],
      ),
    );
